...
import { HandleLoginResponse } from '../../../interfaces/auth/AuthInterface';
...
const LoginScreen = () => {
  ...
  const handleButtonLogin = async () => {
    const result: HandleLoginResponse | void = await handleLogin(credentials.email, credentials.password)
    if (result.success) {
